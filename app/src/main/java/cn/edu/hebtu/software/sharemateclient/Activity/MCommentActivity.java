...
public class MCommentActivity extends AppCompatActivity {
    ...
    private UserBean currentUser;//为当前用户的id
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request request = new Request.Builder()
                .url(serverPath+"/CommentAndReply/getCAndRList/"+currentUser.getUserId())
                .build();
        ...
        private void showPopupWindow(RelativeLayout root, final int position){
                    ...
                    if(like.getText().equals("赞")){
                       //开启异步任务点赞
                        FormBody formBody = new FormBody.Builder()
                                ...
                                .add("userId",currentUser.getUserId()+"")
            ...
            detail.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    window.dismiss();
                    //跳转到笔记详情页面
                    Intent intent = new Intent(MCommentActivity.this,NoteDetailActivity.class);
                    intent.putExtra("note",commentAndReplyList.get(position).getNote());
                    intent.putExtra("contentUser",currentUser);
