...
public class CommentAndReply {
    ...
    public CommentAndReply(int tag, User user, String commentContent, User arguedUser, String commentedContent, String commentDate, Note note, int arguedId, boolean isLike) {
        this.tag = tag;
        this.user = user;
