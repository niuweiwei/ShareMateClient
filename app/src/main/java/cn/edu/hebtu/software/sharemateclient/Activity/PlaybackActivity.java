...
public class PlaybackActivity extends Activity implements
    ...
    public static void start(Activity activity, String mp4Path,UserBean user1) {
        Intent intent = new Intent(activity, PlaybackActivity.class);
    ...
    public static void start(Activity activity, String mp4Path, int previousOrientation, UserBean user1) {
        Intent intent = new Intent(activity, PlaybackActivity.class);
        intent.putExtra(MP4_PATH, mp4Path);
        intent.putExtra("user",user1);
    ...
    public void onUploadVideoSuccess(JSONObject response) {
        try {
            ...
            intent.setClass(PlaybackActivity.this,FabuActivity.class);
